...
class Main:
    ...
    def get_file_db(self, file_path):
        ...
        with closing(sqlite3.connect(self.db_file)) as cnn:
            ...
            cursor.execute(f'SELECT * FROM files WHERE file_path == "{file_path}"')
    ...
    def save_file_status(self, file_path):
        ...
        if len(files_db) > 0:
            ...
            file_is_modify = self.check_file_modification(
...
if __name__ == "__main__":
    ...
    main.delete_other_reserve_path_file(same_file_group_list, reserve_path)
